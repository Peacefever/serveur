...
def collect_sales():
	...
	for dictObject in datas['sales']:
		...
		sold_creation = db.select("INSERT INTO sales (quantity_sales, day_sales, p_id) VALUES (%(quantity)s, %(day)s, %(p_id)s",{"quantity":dictObject['quantity'],"day": currentDay, "p_id":playerID[0]['id_player']})
